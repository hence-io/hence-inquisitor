  ...
  _.extend(self, {
    ...
    startMultiInstall: function (steps, installOptions, done) {
      ...
      _.each(installOptions, function (opts) {
        ...
        if (self._debug) {
          console.log('>> Start multi-install with defaults of: ', _.omit(tempInstaller.defaults, 'dependencies', 'files', 'npmDevDependencies', 'npmDependencies', 'bowerDependencies'), tempInstaller.content, tempInstaller._debug);
        }
