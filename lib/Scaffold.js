        ...
        if (step.length) {
          _.each(step, function (s) {
            if (s.inquire) {
              ...
              self.answers.aborted = true;
              return self.error('The scaffolding steps are miss configured. Please review them');
            }
          });
        }
      }
