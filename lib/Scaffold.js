...
var Scaffold = function (config) {
  ...
  _.extend(scaffold, {
      ...
      if (steps.length) {
        _.each(steps, function (s) {
          ...
          if (_.isFunction(s.inquire)) {
            ...
            return self.error('Your ScaffoldStep is mis-configured. Please ensure it contains an inquire function for' +
              ' prompting.', s);
          }
        });
      }
    ...
    start: function () {
      ...
      // Arguments
      var steps = _.isArray(arguments[0]) ? arguments[0] : (_.isObject(arguments[0]) && _.has(arguments[0], 'inquire') ? arguments[0] : undefined);
      var overrides = !_.isArray(arguments[0]) && _.isObject(arguments[0]) && !_.has(arguments[0], 'inquire') ? arguments[0] : (_.isObject(arguments[1]) ? arguments[1] : undefined);
      var done = arguments[2] || (_.isFunction(arguments[1]) ? arguments[1] : (_.isFunction(arguments[0]) ? arguments[0] : undefined));
    ...
    startMultiInstall: function () {
      ...
      multiInstall(this, steps, overrides, done);
    },
