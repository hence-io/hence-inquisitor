# glush-util [![NPM version][npm-image]][npm-url] [![Build Status][travis-image]][https://travis-ci.org/hence-io/glush-util.svg] [![Coverage Status](https://coveralls.io/repos/hence-io/glush-util/badge.svg?branch=master&service=github)](https://coveralls.io/github/hence-io/glush-util?branch=master) [![Dependency Status][depstat-image]][depstat-url]
